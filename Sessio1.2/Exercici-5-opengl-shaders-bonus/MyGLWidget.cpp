...
void MyGLWidget::creaBuffers ()
{
  ...
  // Activem l'atribut que farem servir per vèrtex (només el 0 en aquest cas)	
  glVertexAttribPointer(vertexLocColor, 3, GL_FLOAT, GL_FALSE, 0, 0);
  glEnableVertexAttribArray(vertexLocColor);
...
void MyGLWidget::carregaShaders()
{
  ...
  vertexLocColor = glGetAttribLocation (program->programId(), "color");
}
